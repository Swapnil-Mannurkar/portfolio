      ...
      <div className="ContactSocial">
        <div className="ContactSocialIcons">
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.linkedin.com/in/swapnil-mannurkar-10ba14247/"
          >
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.instagram.com/_.c_r_a_z_e._/"
          >
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://github.com/Swapnil-Mannurkar"
          >
            <GitHub sx={socialIcon} />
          </a>
        </div>
        <div className="ContactSocialEmail">
          <Email sx={socialEmail} />
          &nbsp;
          <a
            href="mailto:mannurkarswapnil@gmail.com"
            target="_blank"
            rel="noreferrer"
            className="emailLink"
          >
            mannurkarswapnil@gmail.com
          </a>
        </div>
      </div>
